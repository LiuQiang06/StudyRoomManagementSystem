        ...
        <div class="login_box" style="width:500px;">
            ...
            <div class="login_form" style="padding:15px;">
                ...
                <div>
                    ...
                    <div class="form_check_ipt" style="width:400px;">
                        <p>姓名</p>
                        <input id="realName" name="realName" type="text" placeholder="请输入姓名" class=""
                               style="width:380px;margin-top:5px;height:30px;display:block">
                    </div>
                    <div class="form_check_ipt" style="width:400px;">
                        <p>联系电话</p>
                        <input id="celPhone" name="celPhone" type="text" placeholder="请输入联系电话" class=""
                               style="width:380px;margin-top:5px;height:30px;display:block">
                    </div>
                    ...
                    <div class="form_reg_btn" style="width:400px;margin-top:20px">
                        <a style="" href="${pageContext.request.contextPath}/commonapi/sys_login"
                           onclick="">前往登录</a>

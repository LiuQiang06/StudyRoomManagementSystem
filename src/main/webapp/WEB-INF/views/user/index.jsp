        ...
        <div id="menu">
            ...
            <ul>
                ...
                <li>
                    ...
                    <a data-name="桌子预约" data-href="${pageContext.request.contextPath}/user/desk_info"
                       href="javascript:void(0)" onclick="goPage(this)" style="text-align:center"><em>桌子预约 </em></a>

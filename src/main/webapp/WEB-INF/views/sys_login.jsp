...
<div class="wrap login_wrap">
    <div class="content">
            ...
            <div class="login_form" style="padding:15px;">
                ...
                <div>
                    <div class="form_check_ipt" style="width:400px;">
                        <p>登录名</p>
                        <input id="name" name="name" type="text" placeholder="请输入登录名" class=""
                               style="width:380px;margin-top:5px;height:30px;display:block">
                    </div>

                    <div class="form_check_ipt" style="width:400px;">
                        <p>密码</p>
                        <input id="password" name="password" type="password" placeholder="请输入密码" class=""
                               style="width:380px;margin-top:5px;height:30px;display:block">
                    </div>
        ...
        <input name="loginType" type="radio" value="1" id="loginType1" style="margin-left:10px;"/><label
                                for="loginType1">管理员</label>
        </span>


                        <span style="margin-left:10px;">
        <input name="loginType" type="radio" value="2" id="loginType2" style="margin-left:10px;"/><label
                                for="loginType2">用户</label>
        </span>
                    ...
                    <div class="form_reg_btn" style="width:400px;margin-top:20px">
                        <a style="" href="${pageContext.request.contextPath}/commonapi/user_info_regist"
                           onclick="">注册用户</a>

            ...
            <div>
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                    ...
                    <tr id="loginNameParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" placeholder="请输入登录名"
                                                             id="loginName"/> <span style="color:red">*必填</span>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr id="passwordParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" placeholder="请输入密码"
                                                             id="password"/> <span style="color:red">*必填</span>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr id="realNameParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" placeholder="请输入姓名"
                                                             id="realName"/> <span style="color:red">*必填</span>
                            </div>
                        </td>
                    </tr>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4045"></script>

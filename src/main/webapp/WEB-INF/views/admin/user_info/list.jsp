    ...
    <div>
        ...
        <div style="display:inline">
            <p style="display:inline-block;margin-top:30px">
                ...
                <input type="text" class="inpMain" style="color:black;width:250px;" placeholder="请输入登录名进行查询"
                       id="loginName"/>
            </p>
        </div>
        ...
        <div style="display:inline">
            <p style="display:inline-block;margin-top:30px">
                ...
                <input type="text" class="inpMain" style="color:black;width:250px;" placeholder="请输入姓名进行查询"
                       id="realName"/>
            </p>
        </div>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2396"></script>

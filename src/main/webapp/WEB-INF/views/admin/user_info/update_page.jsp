            ...
            <div>
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                    ...
                    <tr id="loginNameParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" value="${data.loginName}"
                                                             placeholder="请输入登录名" id="loginName"/> <span
                    ...
                    <tr id="passwordParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" value="${data.password}"
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=9962"></script>
